...
function NavButton({
    ...
    return (
      ...
      >
        <Link
          href={url}
          className={`uppercase tracking-widest border-solid border ${buttonBorderColor} ${buttonTextColor} w-${width} text-sm max-sm:text-xs ${noPadding ? "p-0" : "p-4"} font-semibold inline-block ${extraClasses}`}
        >
          {displayText}
        </Link>
      </button>
